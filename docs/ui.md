...
Shell
  ...
  owns ServiceManager → FrontlightService, PowerService, TaskDispatchService, BLEService, RPCService, DeviceControlService, TimeService, CalendarService, WeatherService
```
